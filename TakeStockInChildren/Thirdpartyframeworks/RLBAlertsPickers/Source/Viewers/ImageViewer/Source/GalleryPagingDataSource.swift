...
final class GalleryPagingDataSource: NSObject, UIPageViewControllerDataSource {
    ...
    func createItemController(_ itemIndex: Int, isInitial: Bool = false) -> UIViewController {
        ...
        case .video(let fetchImageBlock, let videoURL):
            ...
            let videoController = RBVideoViewController(index: itemIndex, itemCount: itemsDataSource.itemCount(), fetchImageBlock: fetchImageBlock, videoURL: videoURL, scrubber: scrubber, configuration: configuration, isInitialController: isInitial)
