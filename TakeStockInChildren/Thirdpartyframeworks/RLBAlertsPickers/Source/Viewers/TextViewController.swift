...
final public class TextViewerViewController: UIViewController {
    ...
    public init(text kind: Kind) {
        ...
        textView.textContainerInset = UIEdgeInsets.init(top: TextViewerViewController.UI.hInset, left: TextViewerViewController.UI.vInset, bottom: TextViewerViewController.UI.hInset, right: TextViewerViewController.UI.vInset)
