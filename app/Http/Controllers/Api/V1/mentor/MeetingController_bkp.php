...
class MeetingControllerBk extends Controller
{
...
/**++++++++++++++++++++++++++++++++++++++++++++++**/
    public function list(Request $request)
    {
        ...
        if($type == 'requested'){
            ...
            $meeting = DB::table('meeting_users')->select('meeting.*','meeting_status.status','session_method_location.method_value')->join('meeting', 'meeting.id','meeting_users.meeting_id')->leftJoin('meeting_status', 'meeting_status.meeting_id','meeting.id')->leftJoin('session_method_location','session_method_location.id','meeting.session_method_location_id')->where('meeting_users.type','mentor')->where('meeting_users.user_id', $this->user_id)->where('meeting.schedule_time' ,'>=' ,  $cur_date)->where('meeting_status.status', 1)->orderBy('meeting.schedule_time', 'asc')->get()->toarray();
        }else if($type == 'past'){

            $meeting = DB::table('meeting_users')->select('meeting.*','meeting_status.status','session_method_location.method_value')->join('meeting', 'meeting.id','meeting_users.meeting_id')->leftJoin('meeting_status', 'meeting_status.meeting_id','meeting.id')->leftJoin('session_method_location','session_method_location.id','meeting.session_method_location_id')->where('meeting_users.type','mentor')->where('meeting_users.user_id', $this->user_id)->where('meeting.schedule_time' ,'<=' , $cur_date)->orderBy('meeting.schedule_time', 'desc')->get()->toarray();
        }
...
/**++++++++++++++++++++++++++++++++++++++++++++++**/
    public function all(Request $request)
    {
        ...
        $upcoming = DB::table('meeting_users')->select('meeting.*','meeting_status.status','session_method_location.method_value')->join('meeting', 'meeting.id','meeting_users.meeting_id')->leftJoin('meeting_status', 'meeting_status.meeting_id','meeting.id')->leftJoin('session_method_location','session_method_location.id','meeting.session_method_location_id')->where('meeting_users.type','mentor')->where('meeting_users.user_id', $this->user_id)->where('meeting.schedule_time' ,'>=' ,  $cur_date)->where('meeting_status.status', 1)->orderBy('meeting.schedule_time', 'asc')->take(20)->get()->toarray();
        ...
        $past = DB::table('meeting_users')->select('meeting.*','meeting_status.status','session_method_location.method_value')->join('meeting', 'meeting.id','meeting_users.meeting_id')->leftJoin('meeting_status', 'meeting_status.meeting_id','meeting.id')->leftJoin('session_method_location','session_method_location.id','meeting.session_method_location_id')->where('meeting_users.type','mentor')->where('meeting_users.user_id', $this->user_id)->where('meeting.schedule_time' ,'<=' , $cur_date)->orderBy('meeting.schedule_time', 'desc')->take(20)->get()->toarray();
