...
class MenteeCompletedGoalsViewModel(private val fragment: MenteeCompletedGoalsFrag) {

    var listCompleted = ObservableField<List<GoalData>>(emptyList())
    ...
    fun fetchCompletedGoals() {
        fragment.activity?.apply {
            ...
            disposable = apiService.getCompletedGoalData(token)
