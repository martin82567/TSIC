...
class MenteePendingGoalFilesAdapter(
    val mediaList: MutableList<Uploadedfile?>,
    val activity: MenteePendingGoalDetailsActivity
) :
    ...
    override fun onBindViewHolderBase(holder: RecyclerView.ViewHolder?, position: Int) =
        (holder as MenteeGoalFilesHolder).bind(position)
            ...
            .subscribe(
                { result ->
                    activity.apply {
                        ...
                        binding?.vm?.getGoalDetails(activity.goalId)
                    }
                },
                { error ->
    ...
    inner class MenteeGoalFilesHolder(val binding: InflaterMenteeImagesBinding) :
