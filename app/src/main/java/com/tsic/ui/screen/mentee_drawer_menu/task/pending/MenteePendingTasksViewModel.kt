...
class MenteePendingTasksViewModel(private val fragment: MenteePendingTasksFrag) {

    var listPending = ObservableField<List<TaskDatalist>>(emptyList())
    ...
    fun fetchPendingTasks() {
        fragment.activity?.apply {
            ...
            disposable = apiService.getPendingTaskData(token)
