...
class MentorPastMeetingListViewModel(private val fragment: MentorPastMeetingListFrag) {
    ...
    fun fetchMentorPastMeetingList() {
        fragment.activity?.apply {
            ...
            disposable = apiService.getPastMeeting(token)
                    ...
                    { result ->
                        if (result.status == Status.SUCCESS) {
                            ...
                            fragment.binding?.rVMentee?.apply {
                                ...
                                adapter =
                                    tempList?.let { MentorPastMeetingListAdapter(it, fragment) }


                            }

                            /* result.data?.let {
                                 listPastMeeting?.set(it)
                             }*/
                        } else {
