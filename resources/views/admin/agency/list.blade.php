...
$is_view_keyword_allow_access = false;
...
if(Auth::user()->type == 1){
    $is_view_keyword_allow_access = true;
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach ($user_arr as $user)
                        <tr>
                            ...
                            <?php if($is_keyword_allow_access){?>
                            <td>
                                <?php if(Auth::user()->id == $user->parent_id){?>
                                ...
                                <?php }?>
                                <?php }else{
                                    if($is_view_keyword_allow_access){ ?>
                                    <?php if(empty($user->is_allow_keyword_notification)){?>
                                    <a title="No access for other staff"><i class="fa fa-times"></i></a>
                                    <?php }else{?>
                                    <a title="No access for other staff"><i class="fa fa-check"></i></a>
                                    <?php }?>
                                    <?php 
                                    }else{ ?>
                                    <a class="disabled" title="No access for other staff">
                                        <i class="fa fa-ban"></i>
                                    </a>
                                    <?php 
                                    }
