                                ...
                                @if($chats->from_where != 'mentor')
                                    <li class="clearfix">
                                        <div class="message-data align-right">
                                            ...
                                            <span>
                                                <?php 
                                                    $mentor_name = DB::table('mentor')->select('firstname','middlename','lastname')->where('id',$chats->sender_id)->first();
                                                    if(!empty($mentor_name)){
                                                        echo $mentor_name->firstname.' '.$mentor_name->middlename.' '.$mentor_name->lastname;
                                                    }
                                                ?>
                        ...
                        <div class="form-section">
                            <div class="chat-message clearfix">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{url('/admin/chat?type=mentor')}}" class="btn btn-danger">Cancel</a>
...
<input type="hidden" id="receiverId" value="<?php echo $mentor_id; ?>">
