                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <?php
                                                        ...
                                                        if($data->created_by == 1){
                                                            if(Auth::user()->type == 1){
                                                                $victims_list = DB::table('victims')
                                                                    ->join('assign_victim', 'assign_victim.victim_id', '=', 'victims.id')
                                                                    ->select('victims.*')
                                                                    ->where('victims.status',1)
                                                                ...
                                                                $victims_list = DB::table('victims')
                                                                    ...
                                                                    ->select('victims.*')
                                                                    ->where('victims.status',1)
                                                                    ->where('assign_victim.admin_id',Auth::user()->id)
                                                                    ->orderBy('victims.id', 'desc')
                                                                    ->get();
                                                                ...
                                                                if(Auth::user()->parent_id == 1){
                                                                    ...
                                                                    $victims_list = DB::table('victims')
                                                                            ...
                                                                            ->select('victims.*')
                                                                            ->where('victims.status',1)
                                                                            ->where('assign_victim.admin_id',Auth::user()->parent_id)
                                                                            ->orderBy('victims.id', 'desc')
                                                                            ->get();
                                                            ...
                                                            $victims_list = DB::table('victims')
                                                                ...
                                                                ->select('victims.*')
                                                                ->where('victims.status',1)
                                                                ->where('assign_victim.admin_id',$data->created_by)
                                                                ->orderBy('victims.id', 'desc')
                                                                ->get();
                                                        }
                                                        ...
                                                        //$victims_list = DB::table('victims')->where('victims.created_by',$data->created_by)->get();
                                                    ?>
