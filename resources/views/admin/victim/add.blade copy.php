                    ...
                    <div class="row mb-3">                        
                        <div class="col-xl-6 col-md-6">
                            <div class="single-inp">
                                ...
                                <div class="inp">
                                    <input type="email" id="email" name="email" value="<?php echo !empty($victim->email)?$victim->email:'';?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-xl-7">
                                <div class="row">               
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mentee-btnn" data-toggle="modal" data-target="#assign_task_<?php echo $victim->id; ?>">Assign Assignment</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mentee-btnn" onclick="view_gtc('<?php echo $victim->id; ?>','task')">View Assignment</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mentee-btnn" data-toggle="modal" data-target="#assign_goal_<?php echo $victim->id; ?>">Assign Goal</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mentee-btnn" onclick="view_gtc('<?php echo $victim->id; ?>','goal')">View Goal</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
