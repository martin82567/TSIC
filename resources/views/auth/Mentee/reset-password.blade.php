                ...
                <div class="inner">
                    <div class="login-form">
                        <div class="inr">
                            ...
                            <?php } ?>
                            <h3><span><center>MENTEE RESET PASSWORD</center></span></h3>
                            <form class="" method="POST" action="{{ url('/mentee/submit_reset_password') }}">
                                {{ csrf_field() }}  
                            ...
                            <div class="forget-pass">
                                <a href="{{ url('/mentee/forget-password') }}" onclick="event.preventDefault();
                                                 document.getElementById('resend-form').submit();">Resend OTP</a>
                                <form id="resend-form" action="{{ url('/mentee/submit_forget_password') }}" method="POST" style="display: none;">
                                    {{ csrf_field() }}  
