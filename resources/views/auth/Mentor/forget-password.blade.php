                ...
                <div class="inner">
                    <div class="login-form">
                        <div class="inr">
                            ...
                            <?php } ?>
                            <h3><span><center>MENTOR FORGET PASSWORD</center></span></h3>
                            <form class="" method="POST" action="{{ url('/mentor/submit_forget_password') }}">
                                {{ csrf_field() }}
                    ...
                    <div class="login_btn_div">                        
                        <div class="app_btn">
                            ...
                            <a href="https://apps.apple.com/us/app/tsic/id1476056526"><img src="{{url('/public/app_btn.png')}}" target="_blank"></a>
                        </div>
                    </div>  
                </div>
            </div>
