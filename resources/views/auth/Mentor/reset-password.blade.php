                ...
                <div class="inner">
                    <div class="login-form">
                        <div class="inr">
                            ...
                            <?php } ?>
                            <h3><span><center>MENTOR RESET PASSWORD</center></span></h3>
                            <form class="" method="POST" action="{{ url('/mentor/submit_reset_password') }}">
                                {{ csrf_field() }}  
                            ...
                            <div class="forget-pass">
                                <a href="{{url('/mentor/login')}}">Login</a>
                            </div>
                            <strong><center>-or-</center></strong>
                            <div class="forget-pass">
                                <a href="{{ url('/mentor/forget-password') }}" onclick="event.preventDefault();
                                                 document.getElementById('resend-form').submit();">Resend OTP</a>
                                <form id="resend-form" action="{{ url('/mentor/submit_forget_password') }}" method="POST" style="display: none;">
                                    {{ csrf_field() }}  
