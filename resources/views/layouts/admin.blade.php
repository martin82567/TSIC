        ...
        <div class="db-header">
            ...
            <div class="db-header-right">
                <div class="inner clearfix">
                    ...
                    <div class="h-switch">
                        <a href="{{ url('/admin/switch-acc/back-to-admin') }}" title="Back to Admin">
                    ...
                    <div class="side-content">
                        <div class="db-s-menu">
                            <ul>
                                ...
                                <li class="">
                                    <a> <span>Switch Account</span></a>
                                    <ul class="sub-menu" style="display:block !important;">
                                        <li class="<?php if($uri_segment == 'switch-acc' && Request::segment(4) == 'affiliate'){?>active<?php }?>">
                                            <a href="{{ url('/admin/switch-acc/index/affiliate')}}"> <span>Affiliate</span></a>
                                        </li>
                                        <li class="<?php if($uri_segment == 'switch-acc' && Request::segment(4) == 'staff'){?>active<?php }?>">
                                            <a href="{{ url('/admin/switch-acc/index/staff')}}"><span>Staff</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <?php }?>
