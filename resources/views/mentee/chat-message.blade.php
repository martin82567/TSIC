                        ...
                        <div class="form-section">
                            <div class="chat-message clearfix">
                                ...
                                <div class="box-footer">
                                    ...
                                    <?php if($type == 'st'){?>
                                    <a href="{{url('/mentee/chat/userlist?type=st')}}" class="btn btn-danger">Cancel</a>
                                    <?php }else{?>
                                    <a href="{{url('/mentee/chat/userlist?type=mm')}}" class="btn btn-danger">Cancel</a>
                                    <?php }?>
...
<input type="hidden" id="userType" value="mentee">
<input type="hidden" id="userId" value="<?php echo $mentee_id; ?>">
<input type="hidden" id="userName" value="<?php echo $mentee_name; ?>">
