...
Route::match(array('GET', 'POST'), '/videochat/denied_call', 'Api\VideochatController@denied_call');
...
Route::match(array('GET', 'POST'), '/webhook/zoom', 'Api\WebhookController@zoom');
Route::match(array('GET', 'POST'), '/webhook/zoom_recording', 'Api\WebhookController@zoom_recording');
...
|--------------------------------------------------------------------------
*/
Route::post('/v1/check_user', 'Api\V1\UniversalLoginController@check_user');
Route::post('/v1/unified/login', 'Api\V1\UniversalLoginController@login');
Route::post('/v1/unified/forgotpassword', 'Api\V1\UniversalLoginController@forgot_password');
Route::post('/v1/unified/resetpassword', 'Api\V1\UniversalLoginController@reset_password');
...
Route::post('/v1/user/check_waiver', 'Api\V1\UsersController@check_waiver');


Route::post('/v1/user/update_tokens', 'Api\V1\UserController@update_tokens');
...
Route::post('/v1/mentor/check_waiver', 'Api\V1\mentor\UsersController@check_waiver');

Route::post('/v1/mentor/update_tokens', 'Api\V1\mentor\UserController@update_tokens');
...
Route::post('/v1/mentor/delete_meeting', 'Api\V1\mentor\MeetingController@delete');
...
Route::match(array('GET', 'POST'), '/chat/history', 'Api\ChatController@chat_history');

/*+++++++Disclaimer API+++++++*/

Route::match(array('GET', 'POST'), '/disclaimer/index', 'Api\DisclaimerController@index');

Route::group(['prefix' => 'middleware', 'as' => 'middleware.', 'namespace' => 'Salesforce'], function () {
    ...
    Route::get('/getStudentsByOffice', 'MiddlewareController@getStudentsByOffice');
    Route::get('/getStudentMentorMatch', 'MiddlewareController@getStudentMentorMatch');
    Route::get('/getSchoolsForOffice', 'MiddlewareController@getAllSchoolsForOffice');
    Route::get('/getStudentSessionCount', 'MiddlewareController@getStudentSessionCount');
    Route::get('/getMentorSessionCount', 'MiddlewareController@getMentorSessionCount');
    Route::get('/getProgramAndServicesForAgency', 'MiddlewareController@getProgramAndServicesForAgency');
    Route::post('/createSession', 'MiddlewareController@createSession');
});
