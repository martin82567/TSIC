...
Route::get('/dataimport/syncAgencyPrograms', 'DataimportController@syncAgencyPrograms');
/***************************************************************/
...
Auth::routes();
Route::get('/', 'Auth\UniversalLoginController@showLoginForm');
...
Route::prefix('admin')->group(function() {
	...
	Route::match(array('GET','POST'), '/message-center/hide', 'Admin\MessageCenterController@hide')->name('admin.message-center.hide');
	Route::match(array('GET','POST'), '/message-center/unhide', 'Admin\MessageCenterController@unhide')->name('admin.message-center.unhide');
...
Route::get('/login','Auth\UniversalLoginController@showLoginForm')->name('login');
Route::post('/login', 'Auth\UniversalLoginController@login')->name('login.submit');
Route::post('/check_waiver', 'Auth\UniversalLoginController@check_waiver')->name('check_waiver');
Route::post('logout/', 'Auth\UniversalLoginController@logout')->name('logout');
Route::get('/forget-password','Auth\UniversalLoginController@showForgetPassword')->name('forget-password');
Route::post('/submit_forget_password', 'Auth\UniversalLoginController@submit_forget_password')->name('forget-password.submit');
Route::get('/reset-password/{email?}','Auth\UniversalLoginController@showResetPassword')->name('reset-password');
Route::post('/submit_reset_password', 'Auth\UniversalLoginController@submit_reset_password')->name('reset-password.submit');
...
Route::prefix('mentor')->group(function() {
    ...
    Route::get('meeting/delete', 'Mentor\MeetingController@delete')->name('mentor.meeting.delete');
    ...
    Route::get('message_center', 'Mentor\MessageCenterController@index')->name('mentor.message_center.list');
    ...
    Route::match(array('GET','POST'), 'resources', 'Mentor\ResourceController@index')->name('mentor.resources');
    Route::get('change_password', 'Mentor\UpdatePasswordController@edit')->name('mentor.password.edit');
    Route::post('change_password', 'Mentor\UpdatePasswordController@update')->name('mentor.password.update');
});
...
Route::prefix('mentee')->group(function() {
    ...
    Route::match(array('GET','POST'), 'resources', 'Mentee\ResourceController@index')->name('mentee.resources');
    Route::get('my_goals', 'Mentee\GoalController@index')->name('mentee.my_goals');
    Route::get('my_goals/detail', 'Mentee\GoalController@show')->name('mentee.my_goals.show');
    Route::post('goal_note/save/{id}', 'Mentee\GoalController@saveNote')->name('mentee.my_goals_note.save');
    Route::post('my_goals/goal_start/{id}', 'Mentee\GoalController@actiongoaltask')->name('mentee.my_goals_files.save');
    Route::post('goal_files/save/{id}', 'Mentee\GoalController@saveFiles')->name('mentee.my_goals_files.save');
    Route::get('goal_files/delete/{id}', 'Mentee\GoalController@filedeletegoaltask')->name('mentee.my_goals_files.delete');
    Route::get('my_assignments', 'Mentee\AssignmentController@index')->name('mentee.my_assignments');
    Route::get('my_assignments/detail', 'Mentee\AssignmentController@show')->name('mentee.my_assignments.show');
    Route::post('assignment_note/save/{id}', 'Mentee\AssignmentController@saveNote')->name('mentee.my_assignments_note.save');
    Route::post('my_assignments/assignment_start/{id}', 'Mentee\AssignmentController@actiongoaltask')->name('mentee.my_assignments_files.save');
    Route::post('assignment_files/save/{id}', 'Mentee\AssignmentController@saveFiles')->name('mentee.my_assignments_files.save');
    Route::get('assignment_files/delete/{id}', 'Mentee\AssignmentController@filedeletegoaltask')->name('mentee.my_assignments_files.delete');
    Route::get('change_password', 'Mentee\UpdatePasswordController@edit')->name('mentee.password.edit');
    Route::post('change_password', 'Mentee\UpdatePasswordController@update')->name('mentee.password.update');
    Route::get('message_center', 'Mentee\MessageCenterController@index')->name('mentee.message_center.list');
